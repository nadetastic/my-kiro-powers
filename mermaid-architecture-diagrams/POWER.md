...
displayName: "Mermaid Architecture Diagrams"
...
keywords: ["mermaid", "architecture", "diagram", "aws", "infrastructure"]
author: "Dan Kiuna"
---
...
This power generates architecture diagrams as markdown files using Mermaid syntax. The output shows how application components fit together — backend services, databases, external APIs, frontends, and cloud infrastructure — in a single visual diagram.

Each diagram is output as a markdown file inside a folder named after the diagram, containing only a title and the Mermaid code block.
